...
function global:au_SearchReplace {
    @{
        ".\tools\chocolateyInstall.ps1" = @{
            "(ms-azuretools.vscode-azurefunctions@)[^']*" = "`${1}$($Latest.RemoteVersion)"
        }
    }
}

function global:au_GetLatest {
    $Releases = "https://marketplace.visualstudio.com/items?itemName=ms-azuretools.vscode-azurefunctions"
