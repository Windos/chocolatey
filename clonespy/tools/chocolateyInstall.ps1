...
$packageName = 'clonespy' # arbitrary name for the package, used in messages
$installerType = 'EXE' #only one of these: exe, msi, msu
$url = 'http://www.clonespy.com/english/download/cspy313.exe' # download url
$silentArgs = '/S /NODESKTOPSHORTCUT' # "/s /S /q /Q /quiet /silent /SILENT /VERYSILENT" # try any of these to get the silent installer #msi is always /quiet
